...
package org.rcsb.mojave.tools.generators;
 ...
 * @since 1.0.0
 */
public class SchemaEnumsGenerator {

    private boolean withClassNameSuffix;
    ...
    public void withClassNamePostfix(String postfix) {
        withClassNameSuffix = true;
        classNameSuffix = postfix;
    }

    public void run(File schemasDir, File outputDir, String fqp) throws IOException, JClassAlreadyExistsException {
